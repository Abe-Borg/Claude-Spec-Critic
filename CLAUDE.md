...
| `SPEC_CRITIC_RESEARCH_MODEL` | Sonnet 4.6 | Override the requirements-research fan-out model (`PHASE_RESEARCH`). Compliance has **no** env override — it is bound to `COMPLIANCE_MODEL_DEFAULT` = Sonnet 4.6 (cross-check parity). |
