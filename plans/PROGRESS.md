...
- Tests: 3.11 had 4,545 passed, 18 skipped, 23 xfailed. 3.12 with Tk had 4,723 passed, 3 skipped, 26 xfailed. `pip check` was clean, and the JavaScript-required HTML suites passed with `SPEC_CRITIC_REQUIRE_HTML_TEST_TOOLS=1` (the HTML exporter's naming intro changed).
- **Next:** S04.
