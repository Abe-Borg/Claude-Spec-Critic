...
# The occurrence model (plan WP-06B) lives in ``occurrences`` so the report
# exporters and the sidecar writer can use it without importing this module;
# its names are re-exported here for callers that reach them through the
# pipeline.
from .occurrences import (  # noqa: F401
    ELEMENT_LOCATIONS,
    LOCATION_BASES,
    LOCATION_CLAIMED,
